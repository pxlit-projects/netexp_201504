...
namespace GuestRoomAPI.Controllers
{
    public class GuestRoomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BusinessProductGroupId,BusinessProductId,Name,AddressId,LocationId,Phone,Mobile,Email,Website,ProductDescription")] GuestRoom guestRoom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BusinessProductGroupId,BusinessProductId,Name,AddressId,LocationId,Phone,Mobile,Email,Website,ProductDescription")] GuestRoom guestRoom)
        {
            if (ModelState.IsValid)
            {
